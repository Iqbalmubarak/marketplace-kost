...
<div class="navbar-wrapper">
    <nav class="navbar navbar-default navbar-fixed-top navbar-expand-md" role="navigation">
        <div class="container">
            @if(Auth::user())
            <a class="navbar-brand" style="padding: 20px 40px;" onclick="logout()">LOGOUT</a>
            <form id="logout-form" action="{{route('logout')}}" method="POST">@csrf</form>
            @else
            <a class="navbar-brand" style="padding: 20px 40px;" href="#" data-toggle="modal" data-target="#myModal">LOGIN</a>
            @endif
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('login') }}?role=owner">
                        <button type="button" style="padding: 15px 70px;" class="btn btn-primary btn-outline" title="Login sebagai pemilik kos">
                            <img class="img-lg" src="{{ asset('templates/img/owner.png') }}" alt="">
                ...
                <div class="d-flex justify-content-center">
                    <a href="{{ route('login') }}?role=customer">
                        <button type="button" style="padding: 15px 70px;" class="btn btn-primary btn-outline" title="Login sebagai pemilik kos">
                            <img class="img-lg" src="{{ asset('templates/img/customer.png') }}" alt="">
        ...
        <div class="carousel-item active">
            <div class="container">
                ...
                <div class="carousel-image wow zoomIn">
                    <img src="{{ asset('templates/img/landing/laptop.png') }}" alt="laptop"/>
                </div>
            </div>
...
<section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="{{ asset('templates/img/landing/perspective.png') }}" alt="dashboard" class="img-fluid">
        </div>
    ...
    <div class="row features-block">
        ...
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="{{ asset('templates/img/landing/dashboard.png') }}" alt="dashboard" class="img-fluid float-right">
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="{{ asset('templates/img/landing/avatar3.jpg') }}" class="img-fluid rounded-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="{{ asset('templates/img/landing/avatar1.jpg') }}" class="img-fluid rounded-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="{{ asset('templates/img/landing/avatar2.jpg') }}" class="img-fluid rounded-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="{{ asset('templates/img/landing/iphone.jpg') }}" class="img-fluid" alt="dashboard">
            </div>
    ...
    <div class="container">
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="float-left">
                        <img alt="image" src="{{ asset('templates/img/landing/avatar3.jpg') }}">
                    </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="float-left">
                        <img alt="image" src="{{ asset('templates/img/landing/avatar1.jpg') }}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="float-left">
                        <img alt="image" src="{{ asset('templates/img/landing/avatar2.jpg') }}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
...
<script src="{{ asset('templates/js/plugins/wow/wow.min.js') }}"></script>
