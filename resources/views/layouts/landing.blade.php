    ...
    <div class="navbar-wrapper">
        <nav class="navbar navbar-default navbar-fixed-top navbar-expand-md" role="navigation">
            <div class="container">
                ...
                @else
                <a class="navbar-brand" style="padding: 20px 40px;" href="#" data-toggle="modal"
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('login') }}?role=owner">
                            <button type="button" style="padding: 15px 70px;" class="btn btn-primary btn-outline"
    ...
    <section class="container features">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right wow fadeInRight">
                <img src="{{ asset('templates/img/landing/dashboard.png') }}" alt="dashboard"
            ...
            <div class="row">
                <div class="col-sm-4 wow fadeInLeft">
                    <div class="team-member">
                        <img src="{{ asset('templates/img/landing/avatar3.jpg') }}"
                            class="img-fluid rounded-circle img-small" alt="">
                ...
                <div class="col-sm-4">
                    <div class="team-member wow zoomIn">
                        <img src="{{ asset('templates/img/landing/avatar1.jpg') }}" class="img-fluid rounded-circle"
                            alt="">
                ...
                <div class="col-sm-4 wow fadeInRight">
                    <div class="team-member">
                        <img src="{{ asset('templates/img/landing/avatar2.jpg') }}"
                            class="img-fluid rounded-circle img-small" alt="">
