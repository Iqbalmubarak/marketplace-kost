        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <div class="row">
                        <div class="col-10">
                            <h5>List kos yang baru didaftarkan</h5>
                        </div>
                    </div>
                </div>
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-kost-new">
                            <thead>
                                <tr>
                                    <th>Nama Kos</th>
                                    <th>Alamat</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.dataTables-kost-reject').DataTable({
            ...
            // serverSide: true,
            ajax: {
                url: "{{url('api/kost')}}?data=all&&status=3",
                dataSrc: ''
            },
            columns: [{
                    data: 'name'
