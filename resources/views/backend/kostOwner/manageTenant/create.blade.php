    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title">
                <h5>Menambah Penyewa</h5>
            </div>
            <div class="ibox-content">
                {{ Form::open(array('method'=>'POST', 'url' => route('owner.tenant.store'), 'files' => true)) }}
                <div class="form-group row">
                    <label class="col-lg-2 col-form-label">Pilih kost</label>
                    <div class="col-lg-10">
                        {!! Form::select('kost', $kost, null, ['class' => 'form-control selectpicker',
                ...
                <div id="row-tenant" class="row-tenant">
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <div class="avatar-wrapper"><img class="profile-pic" src="" />
                    ...
                    <div class="form-group row"><label class="col-lg-2 col-form-label">Nama</label>
                        <div class="col-lg-4">
                            <input name="name" type="text" placeholder="Nama Penyewa"
                        ...
                        <div class="col-lg-4">
                            {!! Form::select('gender', $gender, null, ['class' => 'form-control selectpicker', 'title' => 'pilih',
                    ...
                    <div class="form-group row"><label class="col-lg-2 col-form-label">Tempat Lahir</label>
                        <div class="col-lg-4">
                            <input name="birth_place" type="text" placeholder="Tempat Lahir Penyewa"
                    ...
                    <div class="form-group row"><label class="col-lg-2 col-form-label">No. Handphone</label>
                        <div class="col-lg-4">
                            <input name="handphone" type="phone" placeholder="No Hp Penyewa"
                        ...
                        <div class="col-lg-4">
                            <input name="emergency" type="text" placeholder="No Hp Wali Penyewa"
                    ...
                    <div class="form-group row"><label class="col-lg-2 col-form-label">Pekerjaan</label>
                        <div class="col-lg-10">
                            {!! Form::select('job', $job, null, ['class' => 'form-control selectpicker', 'title' => 'Pilih',
